...
import com.frog.iot.service.IDeviceUserService;
...
public class DeviceUserController extends BaseController
{
     ...
     * 查询设备用户列表
     */
    @PreAuthorize("@ss.hasPermi('iot:deviceshare:list')")
    @GetMapping("/list")
     ...
     */
    @PreAuthorize("@ss.hasPermi('iot:deviceshare:query')")
     ...
     * 新增设备用户
     */
    @PreAuthorize("@ss.hasPermi('iot:deviceshare:add')")
     ...
     */
    @ApiOperation("修改设备用户")
    @PreAuthorize("@ss.hasPermi('iot:deviceshare:edit')")
     ...
     */
    @ApiOperation("删除设备用户")
    @PreAuthorize("@ss.hasPermi('iot:deviceshare:remove')")
