    ...
    <el-card style="padding-bottom:100px;">
        <el-table v-loading="loading" :data="templateList" @selection-change="handleSelectionChange" border>
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="150">
                <template slot-scope="scope">
                    <el-button size="small" type="primary" style="padding:5px;" icon="el-icon-view" @click="handleUpdate(scope.row)" v-hasPermi="['iot:template:query']" v-if="scope.row.isSys == '0'? true:!isTenant">查看</el-button>
        ...
        <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="100px">
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-form-item label="是否显示" prop="isMonitor" v-show="form.type == 1">
                ...
                <el-form-item label="数据类型" prop="datatype">
                    <el-select v-model="form.datatype" placeholder="请选择数据类型" @change="dataTypeChange" style="width:175px;">
                        ...
                        <el-option key="object" label="对象" value="object" :disabled="form.isMonitor==1"></el-option>
                    </el-select>
                </el-form-item>
